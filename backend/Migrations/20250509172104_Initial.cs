        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false, defaultValue: false),
                    IsWarned = table.Column<bool>(type: "bit", nullable: false, defaultValue: false),
                    WarningLevel = table.Column<int>(type: "int", nullable: true, defaultValue: 0),
                    IsBanned = table.Column<bool>(type: "bit", nullable: false, defaultValue: false),
                    BannedDays = table.Column<int>(type: "int", nullable: true, defaultValue: 0),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PriceInMMK = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    SKU = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    InStockQuantity = table.Column<int>(type: "int", nullable: false, defaultValue: 0),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Warn_Reason = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CustomerAddressDetails_CustomerAddresses_CustomerAddressId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Purchases_CustomerAddresses_CustomerAddressId",
                        column: x => x.CustomerAddressId,
                        principalTable: "CustomerAddresses",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CustomerActions_Products_ProductId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CustomerActions_ProductId",
                table: "CustomerActions",
                column: "ProductId");

            migrationBuilder.CreateIndex(
                name: "IX_CustomerAddressDetails_CustomerAddressId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Purchases_CustomerAddressId",
                table: "Purchases",
                column: "CustomerAddressId");
